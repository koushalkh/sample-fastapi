...
class RequestLoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: Any, skip_paths: set = None):
        ...
        logger.info(
            "Request logging middleware initialized", skip_paths=list(self.skip_paths)
        )
    ...
    async def dispatch(
        ...
        try:
            ...
            # Log response
            self._log_response(
                request, response, correlation_id, request_id, response_time
            )
    ...
    def _log_request(
        self, request: Request, correlation_id: str, request_id: str
    ) -> None:
        """
