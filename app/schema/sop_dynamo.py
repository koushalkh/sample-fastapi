...
class SOPDynamoTable(Model):
    ...
    processed_document_urls = ListAttribute(of=UnicodeAttribute, attr_name="processedDocumentUrls", default=list)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            'processed_document_urls': list(self.processed_document_urls) if self.processed_document_urls else [],
